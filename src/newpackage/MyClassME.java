...
public class MyClassME {

	public static void main(String[] arg)
	{
		
		testSuma(); //so nguyen + so thap phan
		//testSubtracta(); //so nguyen - so thap phan
		//testMula(); //so nguyen * so thap phan
		//testDiva(); //so nguyen : so thap phan
		//testCona(); //so nguyen merge so thap phan
	}
	 

	public static void testSuma() { // so nguyen + so thap phan
		System.setProperty("webdriver.edge.driver", "./src/newpackage/msedgedriver.exe");
